...
class Chat_GUI:
    ...
    def generate_emojies(self):
        ...
        self.button_list = [ range(len(emoji_data))]
        for i, v in emoji_data.items():
            tk.Button(self.base1, font="Helvetica", text=v, bd=0, activebackground="#BDE096", justify="left",
                               command=partial(self.genrate_emoji_index,i)).pack(side="left")

    def genrate_emoji_index(self,ind):
        self.textBox.insert('end',emoji_data[ind])

class Main_GUI(tk.Frame):
    def __init__(self,parent):
        self.parent = parent
        tk.Label(self.parent, text="Eren and Mahmut Chat Tool v1.0",bg='lavender', fg="black", font=("arial", 15, "bold italic")) \
        ...
        self.destinationIP.insert(tk.END,'192.168.43.177')
    ...
    def start_connection(self,host, port, protocol):
        ...
        if self.protocol == "tcp":
            ...
            while True:
                ...
                self.label11 = tk.Label(self.parent, text="Connected....").grid(column=1,
                                                                                                         row=4)
...
def main():
    root = tk.Tk()
    root.title("EM Chat Tool v1.0--Server")
